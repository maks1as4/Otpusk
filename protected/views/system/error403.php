...
<title>Недостаточно прав, ошибка 403</title>
...
<div id="wrapper">
	<div id="content" class="container_14">
		...
		<div class="grid_14">
			<div id="error40x">
				<h1>Не достаточно прав для выполнения действия.</h1>
				<?php echo CHtml::image('/images/logo403.png','error 403',array('class'=>'logo')); ?>
				<div class="inner error403">
					<p>У вас не достаточно прав, чтобы осуществить это действие.</p>
					<div class="button">
