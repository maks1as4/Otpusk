...
?>
	<div class="cell shadow">
		<p class="date"><?php echo $column[7]; ?></p>
		<h2><?php echo CHtml::link($column[2],array('pages/view','type'=>'tourism','id'=>$column[0],'url'=>$column[1])); ?></h2>
<?php
if ($column[4]!='' && $column[5]!='')
{
	...
	echo CHtml::link($src,array('pages/view','type'=>'tourism','id'=>$column[0],'url'=>$column[1]));
}
?>
