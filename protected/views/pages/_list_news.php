...
?>
	<div class="cell shadow">
		...
		<h2><?php echo CHtml::link($column[2],array('pages/view','type'=>'news','id'=>$column[0],'url'=>$column[1])); ?></h2>
<?php
if ($column[4]!='' && $column[5]!='')
{
	...
	echo CHtml::link($src,array('pages/view','type'=>'news','id'=>$column[0],'url'=>$column[1]));
}
?>
