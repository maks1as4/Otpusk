...
if ($page['image']!='' && $page['ext']!='')
{
	...
	$image = CHtml::image('/storage/images/pages/'.$page['image'].'_large.'.$page['ext'],$alt,array('width'=>'380','height'=>'250'));
}
else
...
?>
<?php echo CHtml::link('читать другую полезную информацию',array('pages/list','type'=>'tourism')); ?>